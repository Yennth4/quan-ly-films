package com.yennth.assignment.util;
...
public class HibernateUtil {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=ASM2_J4;encrypt=true;trustServerCertificate=true;");
